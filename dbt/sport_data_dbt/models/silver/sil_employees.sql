...
select
    ...
    case
        when d.declared_transport_mode_normalized in ('marche', 'running', 'marche/running', 'velo', 'trottinette', 'roller', 'skate')
            then true
        else false
    ...
    case
        ...
        when d.declared_transport_mode_normalized in ('velo', 'trottinette', 'roller', 'skate')
